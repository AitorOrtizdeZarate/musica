            ...
            <div class="content col-12">
	            ...
	            <div class="links bg-secondary text-white row justify-content-between align-items-center" >
	               ...
	               <ul class="navbar-nav ml-auto text-white d-flex justify-content-end">
                        ...
                        @guest
                            <li class="nav-item">
                                <a class="nav-link text-white" href="{{ route('login') }}" data-toggle="modal" data-target="#loginModal">{{ __('Login') }}</a>
                            </li>
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="nav-link text-white" href="{{ route('register') }}" data-toggle="modal" data-target="#registerModal">{{ __('Register') }}</a>
                                </li>
                            @endif
                        @else
